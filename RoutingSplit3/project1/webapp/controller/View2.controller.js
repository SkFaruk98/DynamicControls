    ...
    function (Controller,Form,ResponsiveGridLayout,FormContainer,FormElement,Input,Button,History,MessageBox,MessageToast) {
        ...
        return Controller.extend("project1.controller.View2", {
            ...
            onSelectOfEdu: function () {
                let aSelected=this.byId("stuEdu").getSelectedItems();
                let condition= aSelected.length!=0?true:false;
                this.getView().getModel("labelModel").setProperty("/ButtonOfEdu", condition);
              

            },
            onSelectOfEmp: function () {
                let aSelected=this.byId("stuEmp").getSelectedItems();
                let condition= aSelected.length!=0?true:false;
                this.getView().getModel("labelModel").setProperty("/ButtonOfEmp", condition);
            },
