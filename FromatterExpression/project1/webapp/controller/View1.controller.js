        ...
        return Controller.extend("project1.controller.View1", {
            ...
            onInit: function () {
                ...
                const sModel = new sap.ui.model.json.JSONModel({
                    ...
                    persons: [
                            ...
                            education: [
                                { course: "SSC", institution: "Basara", YearOfPass: "2016", Aggregation: "86" },
                                { course: "Diploma", institution: "MBTS", YearOfPass: "2019", Aggregation: "80" },
                                { course: "B.tech", institution: "KHIT", YearOfPass: "2022", Aggregation: "69" }
                            ],
                            employment: [
                                { Company: "Pivox Labs", Role: "Junior Software Developer", YearOfJoin: 2022, YearOfEnd: "-", PhoneNumber: 8523860089} ]
                        },
                        {
                            id: 2, name: "Naveen", totalmarks: 0, experience: 0,
                            education: [
                                { course: "SSC", institution: "Basara", YearOfPass: "2016", Aggregation: "76" },
                                { course: "Diploma", institution: "MBTS", YearOfPass: "2019", Aggregation: "70" },
                                { course: "B.tech", institution: "KHIT", YearOfPass: "2022", Aggregation: "79" } ],
                            employment: [
                                { Company: "Infosys", Role: "Junior Software Developer", YearOfJoin: 2019, YearOfEnd: 2022, PhoneNumber: 8523860089},
                                { Company: "Pivox", Role: "Senior Software Developer", YearOfJoin: 2023, YearOfEnd: "-", PhoneNumber: 8523860089} ]
                        },
                    ]
                })
            ...
            onSavePerson: function () {
                ...
                if (createof) {
                    ...
                    if (findof) {
                        aPersons.push({ id: oPerson.id, name: oPerson.name, education: [], employment: [], experience: 0, totalmarks: 0 });
                        this.getView().getModel("studentModel").setProperty("/persons", aPersons);
                        this.byId("sel").setMode("SingleSelectMaster");
                        oPerson.id = "";
                        oPerson.name = "";
            ...
            percCalculate: function () {
                ...
                aPersons.forEach(oPerson => {
                    if (oPerson.id == sId) {
                        ...
                        let selModel=new sap.ui.model.json.JSONModel(oPerson)
                        this.getView().setModel(selModel,"sModel")
