...
sap.ui.define([
    ...
    function (UIComponent, Device, models,ResourceModel) {
        ...
        operators:[
         ...
         //For Create Input
         input:[{ customerId:"" , orderId: "", orderDate: "", numberOfItems: "", status: "",customerName: "", amount: "",  paymentType: "" }],
        intialInput:[{ customerId:"" , orderId: "", orderDate: "", numberOfItems: "", status: "",customerName: "", amount: "",  paymentType: "" }],
