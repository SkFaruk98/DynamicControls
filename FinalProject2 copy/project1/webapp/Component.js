...
sap.ui.define([
    ...
    function (UIComponent, Device, models,ResourceModel) {
        ...
        return UIComponent.extend("project1.Component", {
         ...
         //For Create Input
         orderInput:{ customerId:"" , orderId: "", orderDate: "", numberOfItems: "", status: "",customerName: "", amount: "",  paymentType: "" },
         intialOrderInput:{ customerId:"" , orderId: "", orderDate: "", numberOfItems: "", status: "",customerName: "", amount: "",  paymentType: "" },
        
        
         itemInput:[{customerId: "", itemName:"" , catogery: "", quantity: "", singleUnitAmount: ""}],
         intialItemInput:[{customerId: "", itemName:"" , catogery: "", quantity: "", singleUnitAmount: ""}],
